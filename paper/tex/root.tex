...
\section{METHODOLOGY}
The concept presented in this paper aims to offer a logical description for road networks which can be translated into a concrete standardized format. We use XML to store the input and the corresponding OpenDRIVE output is saved in XML as well. With the logical description comes a road generation tool that calculates all required OpenDRIVE quantities from the simplified input.
