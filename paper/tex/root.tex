...
\subsection{Segments}\label{sec_segments}
...
\begin{figure*}
	...
	\caption[dummy2]{OpenDRIVE output of a road network generated by the tool which processes the developed logical road description. The road network consists of three junctions, one roundabout, one connection road and four automatically generated road network closing roads. Visualization with internal Unity\footnotemark~tool.}
	\label{fig_resHuge}
...
\addtolength{\textheight}{-10.8cm}   % This command serves to balance the column lengths
