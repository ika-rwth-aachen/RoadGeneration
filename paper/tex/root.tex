...
\begin{figure*}[ht]
	...
	\caption{OpenDRIVE Output of a road network generated by the tool which processes the developed logical road description. \emph{poor quality. Somehow think of something better}}
	\label{fig_resHuge}
\end{figure*}
\begin{table}[hbt]
