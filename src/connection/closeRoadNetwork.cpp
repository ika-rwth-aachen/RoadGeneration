 ...
 */
int RoadNetwork::closeRoadNetwork(pugi::xml_document &doc)
{
	...
	if (!closeRoad)
	{
		std::cerr << "ERR: 'closeRoadNetwork' is not specified in input file." << std::endl;
		std::cerr << "\t -> skip closing" << std::endl;
		return 0;
	}
